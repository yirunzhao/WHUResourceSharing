...
from ..download import views as dviews
from . import views
...
urlpatterns = [
    ...
    path('user/<std_id>/',views.user_page,name='base_user'),
    ...
    #djc
    path('user/<user_id>/upload/', views.upload_view, name='upload_view'),
    path('user/<user>/download/<uid>',views.download_file, name = 'dld')]
